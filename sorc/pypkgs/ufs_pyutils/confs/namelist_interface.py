...
class Namelist:
    ...
    def check_float(self: Generic, string: str) -> bool:
        """
        Description
        ----------
    ...
    def dblequotes_strip(self: Generic, nml_path: str) -> None:
        """
        Description
        -----------
    ...
    def write(self: Generic, nml_dict: Dict, nml_template: str, nml_path: str) -> None:
        """
        Description
        -----------
    ...
    def run(self: Generic, nml_dict: Dict, nml_template: str, nml_path: str) -> None:
        """
        Description
        -----------
