...
def __aws_credentials__(profile_name: str = None) -> Tuple[bool, object]:
    """
    Description
    -----------
...
def __client__(
    ...
    if session is not None:
        session = __session__(profile_name=profile_name)
...
def __list__(client: object, bucket: str, object_path: str = None) -> List:
    """
    Description
    -----------
...
def __read__(client: object, bucket: str, file_name: str, object_name: str) -> None:
    """
    Description
    -----------
...
def __session__(profile_name: str) -> Session:
    """
    Description
    -----------
...
def __write__(client: object, bucket: str, file_name: str, object_name: str) -> None:
    """
    Description
    -----------
...
def filelist(
    ...
    (unsigned, session) = __aws_credentials__(profile_name=profile_name)
    client = __client__(
        unsigned=unsigned, session=session, profile_name=profile_name, resource=resource
    )
    filelist = __list__(client=client, bucket=bucket, object_path=object_path)
