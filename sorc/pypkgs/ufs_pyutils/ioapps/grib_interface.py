...
def __get_app_path__(app: str) -> str:
    """
    Description
    -----------
...
def cnvgribg21(in_grib_file: str, out_grib_file: str) -> None:
    ...
    cnvgrib = __get_app_path__(app="cnvgrib")
...
def grbindex(in_grib_file: str, out_gribidx_file: str, is_grib2: bool = False) -> None:
    ...
    # proceed accordingly.
    if is_grib2:
        grbindex_exe = __get_app_path__(app="grb2index")
    if not is_grib2:
        grbindex_exe = __get_app_path__(app="grbindex")
...
def parse_file(
    ...
    if is_grib2:
        wgrib = __get_app_path__(app="wgrib2")
        cmd_base = [wgrib, in_grib_file, "-match"]
    if not is_grib2:
        wgrib = __get_app_path__(app="wgrib")
        cmd_base = [wgrib]
